...
descriptions named con =
  ...
  case con of
    ...
    GadtC    {}   -> fclError "Analyse.descriptions: GadtC not supported yet"
    RecGadtC {}   -> fclError "Analyse.descriptions: RecGadtC not supported yet"
...
unifiableConstructor a b = and (zipWith unifiable (indices a) (indices b))
  where indices con =
          case con of
            NormalC {}    -> []
            RecC    {}    -> []
            GadtC    {}   -> fclError "Analyse.unifiableConstructor: GadtC not supported yet"
            RecGadtC {}   -> fclError "Analyse.unifiableConstructor: RecGadtC not supported yet"
            InfixC  {}    -> []
...
fieldNamesAndTypes con =
  case con of
    ...
    GadtC    {}   -> fclError "Analyse.fieldNamesAndTypes: GadtC not supported yet"
    RecGadtC {}   -> fclError "Analyse.fieldNamesAndTypes: RecGadtC not supported yet"
